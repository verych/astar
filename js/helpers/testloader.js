...
var scripts = ['assets', 'appobject', 'appsprite' ,'start', 'finish', 'soldier', 'soldosapience', 'map', 'info', 'tower', 'shooter', 'bullet', 'explosion', 'menu', 'core', 'levels'],
    scriptsIndex = 0;
